...
export class ManageOrderComponent implements OnInit {
  ...
  constructor(
    ...
    private spnackBarService:SnackbarService,
  ...
  getCategories(){
    this.categoryService.getFilteredCategories().subscribe(
      ...
      (error:any) => {
        ...
        this.spnackBarService.openSnakBar(this.responseMessage,GlobalConstants.error);
      }
    )
  }
  ...
  setQuantity(value:any){
    ...
    if(temp > 0){
      ...
      this.manageOrderForm.controns['quantity'].setValue('1');
      this.manageOrderForm.controns['total'].setValue(this.manageOrderForm.controns['quantity'].value * this.manageOrderForm.controns['price'].value);
    }
  }
  ...
  add(){
    ...
    if(productName === undefined){
      ...
      this.spnackBarService.openSnakBar(GlobalConstants.productAdded, "success");
    }else{
      this.spnackBarService.openSnakBar(GlobalConstants.productExistsError, GlobalConstants.error);
    }
  }
